...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<ul class="page_menu clear">
					<li><a href="index.jsp" class="on">회원가입</a></li>
				</ul>
			</div>
		</div>	
		<!-- //location_area -->
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="/join" method="POST" class="appForm">
				<fieldset>
					...
					<ul class="app_list">
						<li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" class="w160" id="email_lbl" name="memberId" title="이메일 주소" />
						...
						<li class="clear">
							...
							<div class="app_content"><input type="password" class="w100p" id="pwd_lbl" name="memberPw" placeholder="비밀번호를 입력해주세요"/></div>
						</li>
						<li class="clear">
