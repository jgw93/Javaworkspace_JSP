...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<ul class="bbsview_list" items="${dtoList}" var="dto">
				<li class="bbs_title" > <span type="text" name="title" value="${dto.title}" readonly></span></li>
				<li class="bbs_hit">작성일 : <span type="date" name="createdate" value="${dto.createDate}" readonly></span></li>
				<li class="bbs_date">조회수 : <span type="text" name="count" value="${dto.count}" readonly></span></li>
				<li class="bbs_content"> <span type="text" name="content" value="${dto.content}" readonly></span></li>
